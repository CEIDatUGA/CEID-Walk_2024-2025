...
Run this after downloading the weekly data from the CDC website.

```{r}

# change the date  to the correct new dataset!!!!!
NHSN_data <- read_csv("weekly_forecasts/preliminary_data/Weekly_Hospital_Respiratory_Data__HRD__Metrics_by_Jurisdiction__National_Healthcare_Safety_Network__NHSN___Preliminary__20250102.csv") %>% 
  as_tibble() %>% 
...
```{r}
# write CSV
write_csv(combined_results, file = "weekly_forecasts/UGA_CEID-Walk/2025-02-04-UGA_CEID-Walk.csv")
```
