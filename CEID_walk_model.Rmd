...
Then it creates an empity matrix for storing simulations.
...
Now we have 1 column (h=1) where we will save 100 simulations for each forecast horizion (h)

(100 is based on npaths=1e2 which was previously defined)

```{r}
# Running 100 simulations with the model for the same date
